...
This is different from clear(). With clear(), the dictionary exists but
is empty. With del, the variable itself is removed, and trying to use it
...
not_a_copy = original # This is just another name for the same
dictionary
...
you work with dictionaries, the more natural they’ll become, and you’ll
start recognizing situations where they’re the perfect tool for the job.
...
If you’re unsure about any of these concepts, review the relevant
sections of this chapter and practice with the exercises provided.
